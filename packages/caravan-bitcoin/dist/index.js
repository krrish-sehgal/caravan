...
__export(src_exports, {
  Braid: () => Braid,
  EXTENDED_PUBLIC_KEY_VERSIONS: () => EXTENDED_PUBLIC_KEY_VERSIONS,
  ExtendedPublicKey: () => ExtendedPublicKey,
  FeeValidationError: () => FeeValidationError,
  MULTISIG_ADDRESS_TYPES: () => MULTISIG_ADDRESS_TYPES,
  Network: () => Network,
  P2SH: () => P2SH,
  P2SH_P2WSH: () => P2SH_P2WSH,
  P2WSH: () => P2WSH,
  PSBT_MAGIC_B64: () => PSBT_MAGIC_B64,
  PSBT_MAGIC_BYTES: () => PSBT_MAGIC_BYTES,
  PSBT_MAGIC_HEX: () => PSBT_MAGIC_HEX,
  PsbtV2: () => PsbtV2,
  PsbtV2Maps: () => PsbtV2Maps,
  ROOT_FINGERPRINT: () => ROOT_FINGERPRINT,
  TEST_FIXTURES: () => TEST_FIXTURES,
  ZERO: () => ZERO,
  addSignaturesToPSBT: () => addSignaturesToPSBT,
  autoLoadPSBT: () => autoLoadPSBT,
  bip32PathToSequence: () => bip32PathToSequence,
  bip32SequenceToPath: () => bip32SequenceToPath,
  bitcoinsToSatoshis: () => bitcoinsToSatoshis,
  blockExplorerAPIURL: () => blockExplorerAPIURL,
  blockExplorerAddressURL: () => blockExplorerAddressURL,
  blockExplorerTransactionURL: () => blockExplorerTransactionURL,
  blockExplorerURL: () => blockExplorerURL,
  braidAddressType: () => braidAddressType,
  braidConfig: () => braidConfig,
  braidExtendedPublicKeys: () => braidExtendedPublicKeys,
  braidIndex: () => braidIndex,
  braidNetwork: () => braidNetwork,
  braidRequiredSigners: () => braidRequiredSigners,
  calculateBase: () => calculateBase,
  calculateTotalWitnessSize: () => calculateTotalWitnessSize,
  checkFeeError: () => checkFeeError,
  checkFeeRateError: () => checkFeeRateError,
  compressPublicKey: () => compressPublicKey,
  convertExtendedPublicKey: () => convertExtendedPublicKey,
  deriveChildExtendedPublicKey: () => deriveChildExtendedPublicKey,
  deriveChildPublicKey: () => deriveChildPublicKey,
  deriveExtendedPublicKey: () => deriveExtendedPublicKey,
  deriveMultisigByIndex: () => deriveMultisigByIndex,
  deriveMultisigByPath: () => deriveMultisigByPath,
  estimateMultisigP2SHTransactionVSize: () => estimateMultisigP2SHTransactionVSize,
  estimateMultisigP2SH_P2WSHTransactionVSize: () => estimateMultisigP2SH_P2WSHTransactionVSize,
  estimateMultisigP2WSHTransactionVSize: () => estimateMultisigP2WSHTransactionVSize,
  estimateMultisigTransactionFee: () => estimateMultisigTransactionFee,
  estimateMultisigTransactionFeeRate: () => estimateMultisigTransactionFeeRate,
  extendedPublicKeyRootFingerprint: () => extendedPublicKeyRootFingerprint,
  fingerprintToFixedLengthHex: () => fingerprintToFixedLengthHex,
  generateBip32DerivationByIndex: () => generateBip32DerivationByIndex,
  generateBip32DerivationByPath: () => generateBip32DerivationByPath,
  generateBraid: () => generateBraid,
  generateMultisigFromHex: () => generateMultisigFromHex,
  generateMultisigFromPublicKeys: () => generateMultisigFromPublicKeys,
  generateMultisigFromRaw: () => generateMultisigFromRaw,
  generatePublicKeysAtIndex: () => generatePublicKeysAtIndex,
  generatePublicKeysAtPath: () => generatePublicKeysAtPath,
  getAddressType: () => getAddressType,
  getFeeErrorMessage: () => getFeeErrorMessage,
  getFingerprintFromPublicKey: () => getFingerprintFromPublicKey,
  getMaskedDerivation: () => getMaskedDerivation,
  getNetworkFromPrefix: () => getNetworkFromPrefix,
  getParentBIP32Path: () => getParentBIP32Path,
  getPsbtVersionNumber: () => getPsbtVersionNumber,
  getRedeemScriptSize: () => getRedeemScriptSize,
  getRelativeBIP32Path: () => getRelativeBIP32Path,
  getWitnessSize: () => getWitnessSize,
  hardenedBIP32Index: () => hardenedBIP32Index,
  hash160: () => hash160,
  isKeyCompressed: () => isKeyCompressed,
  isValidSignature: () => isValidSignature,
  multisigAddress: () => multisigAddress,
  multisigAddressType: () => multisigAddressType,
  multisigBIP32Path: () => multisigBIP32Path,
  multisigBIP32Root: () => multisigBIP32Root,
  multisigBraidDetails: () => multisigBraidDetails,
  multisigPublicKeys: () => multisigPublicKeys,
  multisigRedeemScript: () => multisigRedeemScript,
  multisigRequiredSigners: () => multisigRequiredSigners,
  multisigScript: () => multisigScript,
  multisigSignatureBuffer: () => multisigSignatureBuffer,
  multisigTotalSigners: () => multisigTotalSigners,
  multisigWitnessScript: () => multisigWitnessScript,
  networkData: () => networkData,
  networkLabel: () => networkLabel,
  parseSignatureArrayFromPSBT: () => parseSignatureArrayFromPSBT,
  parseSignaturesFromPSBT: () => parseSignaturesFromPSBT,
  psbtInputFormatter: () => psbtInputFormatter,
  psbtOutputFormatter: () => psbtOutputFormatter,
  satoshisToBitcoins: () => satoshisToBitcoins,
  scriptToHex: () => scriptToHex,
  scriptToOps: () => scriptToOps,
  signatureNoSighashType: () => signatureNoSighashType,
  signedMultisigTransaction: () => signedMultisigTransaction,
  sortInputs: () => sortInputs,
  toHexString: () => toHexString,
  translatePSBT: () => translatePSBT,
  unsignedMultisigPSBT: () => unsignedMultisigPSBT,
  unsignedMultisigTransaction: () => unsignedMultisigTransaction,
  unsignedTransactionObjectFromPSBT: () => unsignedTransactionObjectFromPSBT,
  validBase64: () => validBase64,
  validateAddress: () => validateAddress,
  validateBIP32Index: () => validateBIP32Index,
  validateBIP32Path: () => validateBIP32Path,
  validateBip32PathForBraid: () => validateBip32PathForBraid,
  validateExtendedPublicKey: () => validateExtendedPublicKey,
  validateExtendedPublicKeyForNetwork: () => validateExtendedPublicKeyForNetwork,
  validateFee: () => validateFee,
  validateFeeRate: () => validateFeeRate,
  validateHex: () => validateHex,
  validateMultisigInput: () => validateMultisigInput,
  validateMultisigInputs: () => validateMultisigInputs,
  validateMultisigSignature: () => validateMultisigSignature,
  validateOutput: () => validateOutput,
  validateOutputAmount: () => validateOutputAmount,
  validateOutputs: () => validateOutputs,
  validatePrefix: () => validatePrefix,
  validatePublicKey: () => validatePublicKey,
  validateRootFingerprint: () => validateRootFingerprint,
  validateTransactionID: () => validateTransactionID,
  validateTransactionIndex: () => validateTransactionIndex
});
...
// src/networks.ts
var import_bitcoinjs_lib_v5 = require("bitcoinjs-lib-v5");
...
function networkData(network) {
  switch (network) {
    case "mainnet" /* MAINNET */:
      return import_bitcoinjs_lib_v5.networks.bitcoin;
    case "testnet" /* TESTNET */:
      return import_bitcoinjs_lib_v5.networks.testnet;
    case "regtest" /* REGTEST */:
      return import_bitcoinjs_lib_v5.networks.regtest;
    case "signet" /* SIGNET */:
...
function validateAddress(address, network) {
  ...
  let valid = (0, import_bitcoin_address_validation.validate)(
    address,
    network
  );
  if (!valid && network === "regtest" /* REGTEST */) {
    valid = (0, import_bitcoin_address_validation.validate)(address, import_bitcoin_address_validation.Network.testnet);
  }
...
function txoutSize(scriptPubkeySize = 34) {
  const VAL_BYTES = 8;
  const scriptLengthBytes = import_bufio.encoding.sizeVarint(scriptPubkeySize);
...
function getWitnessSize(m4, n3) {
  ...
  const WITNESS_ITEMS_COUNT = import_bufio.encoding.sizeVarint(1 + m4 + 1);
...
function calculateBase(inputsCount, outputsCount) {
  ...
  total += 4;
  total += 4;
  total += import_bufio.encoding.sizeVarint(inputsCount);
  total += inputsCount * txinSize();
  total += import_bufio.encoding.sizeVarint(outputsCount);
...
function calculateTotalWitnessSize({ numInputs, m: m4, n: n3 }) {
  ...
  total += 1;
  total += 1;
  total += import_bufio.encoding.sizeVarint(numInputs);
...
var import_bitcoinjs_lib_v52 = require("bitcoinjs-lib-v5");
import_bignumber.default.config({ EXPONENTIAL_AT: 16 });
...
function satoshisToBitcoins(satoshis) {
  const originalValue = new import_bignumber.default(satoshis);
  const roundedValue = originalValue.integerValue(import_bignumber.default.ROUND_DOWN);
  return roundedValue.shiftedBy(-8).toString();
}
function bitcoinsToSatoshis(btc) {
  return new import_bignumber.default(btc).shiftedBy(8).integerValue(import_bignumber.default.ROUND_DOWN).toString();
}
var ZERO = new import_bignumber.default(0);
function hash160(buf) {
  return import_bitcoinjs_lib_v52.crypto.ripemd160(import_bitcoinjs_lib_v52.crypto.sha256(buf));
}

// src/multisig.ts
var import_bitcoinjs_lib_v53 = require("bitcoinjs-lib-v5");
...
function generateMultisigFromPublicKeys(network, addressType, requiredSigners, ...publicKeys) {
  const multisig = import_bitcoinjs_lib_v53.payments.p2ms({
    m: requiredSigners,
    pubkeys: publicKeys.map((hex) => import_buffer.Buffer.from(hex, "hex")),
...
function generateMultisigFromHex(network, addressType, multisigScriptHex) {
  const multisig = import_bitcoinjs_lib_v53.payments.p2ms({
    output: import_buffer.Buffer.from(multisigScriptHex, "hex"),
    network: networkData(network)
  });
  return generateMultisigFromRaw(addressType, multisig);
}
function generateMultisigFromRaw(addressType, multisig) {
  switch (addressType) {
    case P2SH:
      return import_bitcoinjs_lib_v53.payments.p2sh({ redeem: multisig });
    case P2SH_P2WSH:
      return import_bitcoinjs_lib_v53.payments.p2sh({
        redeem: import_bitcoinjs_lib_v53.payments.p2wsh({ redeem: multisig })
      });
    case P2WSH:
      return import_bitcoinjs_lib_v53.payments.p2wsh({ redeem: multisig });
    default:
      return null;
  }
}
...
// src/keys.ts
var import_bitcoinjs_lib_v54 = require("bitcoinjs-lib-v5");
var bip32 = __toESM(require("bip32"));
...
var ExtendedPublicKey = class _ExtendedPublicKey extends import_bufio2.Struct {
  path;
  sequence;
  index;
  depth;
   ...
   */
  toBase58() {
    return import_bs58check.default.encode(this.encode());
  }
  /**
  ...
  static fromBase58(data) {
    return _ExtendedPublicKey.decode(import_bs58check.default.decode(data));
  }
  /**
...
function convertExtendedPublicKey(extendedPublicKey, targetPrefix) {
  try {
    ...
    const decodedExtendedPublicKey = import_bs58check.default.decode(extendedPublicKey.trim());
    const extendedPublicKeyNoPrefix = decodedExtendedPublicKey.slice(4);
    const extendedPublicKeyNewPrefix = import_buffer.Buffer.concat([
      import_buffer.Buffer.from(EXTENDED_PUBLIC_KEY_VERSIONS[targetPrefix], "hex"),
      extendedPublicKeyNoPrefix
    ]);
    return import_bs58check.default.encode(extendedPublicKeyNewPrefix);
  } catch (err) {
    const e4 = err;
...
function validatePublicKey(pubkeyHex, addressType) {
  ...
  try {
    import_bitcoinjs_lib_v54.ECPair.fromPublicKey(import_buffer.Buffer.from(pubkeyHex, "hex"));
  } catch (e4) {
...
function compressPublicKey(publicKey) {
  const pubkeyBuffer = import_buffer.Buffer.from(publicKey, "hex");
  const prefix = (pubkeyBuffer[64] & 1) !== 0 ? 3 : 2;
  const prefixBuffer = import_buffer.Buffer.alloc(1);
  prefixBuffer[0] = prefix;
  return import_buffer.Buffer.concat([prefixBuffer, pubkeyBuffer.slice(1, 1 + 32)]).toString(
    "hex"
  );
}
...
function isKeyCompressed(_pubkey) {
  let pubkey = _pubkey;
  if (!import_buffer.Buffer.isBuffer(_pubkey))
    pubkey = import_buffer.Buffer.from(_pubkey, "hex");
...
function getFingerprintFromPublicKey(_pubkey) {
  ...
  const pubkeyBuffer = import_buffer.Buffer.from(pubkey, "hex");
...
var Braid = class extends import_bufio3.Struct {
  addressType;
  network;
  extendedPublicKeys;
  requiredSigners;
...
function derivePublicKeyObjectsAtPath(braid, path) {
  ...
  braidExtendedPublicKeys(braid).forEach((xpub) => {
    ...
    dataRichPubKeyObjects[pubkey] = {
      masterFingerprint: import_buffer.Buffer.from(masterFingerprint, "hex"),
      path: completePath,
      pubkey: import_buffer.Buffer.from(pubkey, "hex")
    };
  });
...
// src/fees.ts
import_bignumber2.default.config({ EXPONENTIAL_AT: 16 });
var MAX_FEE_RATE_SATS_PER_VBYTE = new import_bignumber2.default(1e3);
var MAX_FEE_SATS = new import_bignumber2.default(25e5);
...
function checkFeeError(feeSats, inputsTotalSats) {
  let fs, its;
  try {
    fs = new import_bignumber2.default(feeSats);
  } catch (e4) {
  ...
  try {
    its = new import_bignumber2.default(inputsTotalSats);
  } catch (e4) {
...
function checkFeeRateError(feeRateSatsPerVbyte) {
  let fr;
  try {
    fr = new import_bignumber2.default(feeRateSatsPerVbyte);
  } catch (e4) {
...
function estimateMultisigTransactionFeeRate(config) {
  ...
  return new import_bignumber2.default(config.feesInSatoshis).dividedBy(vSize).toString();
}
function estimateMultisigTransactionFee(config) {
  ...
  const feeAsNumber = new import_bignumber2.default(config.feesPerByteInSatoshis).multipliedBy(vSize).toNumber();
...
// src/fixtures.ts
import_bignumber3.default.config({ EXPONENTIAL_AT: 16 });
...
var BRAIDS = [
  {
    ...
    bip32Derivations: {
      index: {
        0: [
          {
            masterFingerprint: import_buffer.Buffer.from("f57ec65d", "hex"),
            path: "m/45'/1'/100'/0/0",
            pubkey: import_buffer.Buffer.from(
              "02a8513d9931896d5d3afc8063148db75d8851fd1fc41b1098ba2a6a766db563d4",
              "hex"
            )
          },
          {
            masterFingerprint: import_buffer.Buffer.from("00000001", "hex"),
            path: "m/45'/1'/100'/0/0",
            pubkey: import_buffer.Buffer.from(
              "03938dd09bf3dd29ddf41f264858accfa40b330c98e0ed27caf77734fac00139ba",
              "hex"
    ...
    transaction: {
      outputs: [
        ...
        },
        {
          ...
          redeemScript: import_buffer.Buffer.from(
      ...
      outputs: [
        ...
        },
        {
          ...
          bip32Derivation: [
            ...
            {
              masterFingerprint: import_buffer.Buffer.from("00000002", "hex"),
              path: "m/48'/1'/100'/1'/1/0",
              pubkey: import_buffer.Buffer.from(
          ...
          witnessScript: import_buffer.Buffer.from(
      ...
      outputs: [
        ...
        },
        {
          ...
          bip32Derivation: [
            ...
            {
              masterFingerprint: import_buffer.Buffer.from("00000003", "hex"),
              path: "m/48'/1'/100'/2'/1/0",
              pubkey: import_buffer.Buffer.from(
      ...
      outputs: [
        ...
        },
        {
          ...
          bip32Derivation: [
            ...
            {
              masterFingerprint: import_buffer.Buffer.from("00000004", "hex"),
              path: "m/45'/0'/100'/1/0",
              pubkey: import_buffer.Buffer.from(
      ...
      outputs: [
        ...
        },
        {
          ...
          bip32Derivation: [
            ...
            {
              masterFingerprint: import_buffer.Buffer.from("00000005", "hex"),
              path: "m/48'/0'/100'/1'/1/0",
              pubkey: import_buffer.Buffer.from(
      ...
      outputs: [
        ...
        },
        {
          ...
          bip32Derivation: [
            ...
            {
              masterFingerprint: import_buffer.Buffer.from("00000006", "hex"),
              path: "m/48'/0'/100'/2'/1/0",
              pubkey: import_buffer.Buffer.from(
  ...
  return {
    ...
    ...{
      ...
      utxos: test.utxos.map((utxo) => ({
        ...utxo,
        ...{
          amountSats: new import_bignumber3.default(utxo.amountSats).toString(),
      ...
      transaction: {
        ...
        ...{
          outputs: test.transaction.outputs.map((output) => ({
            ...output,
            ...{ amountSats: new import_bignumber3.default(output.amountSats).toString() },
            ...{
...
function validateOutputAmount(amountSats, maxSats, minSats = DUST_LIMIT_SATS) {
  let a3, its;
  try {
    a3 = new import_bignumber4.default(amountSats);
  } catch (e4) {
  ...
  if (maxSats !== void 0) {
    try {
      its = new import_bignumber4.default(maxSats);
    } catch (e4) {
...
// src/psbt.ts
var import_bitcoinjs_lib_v55 = require("bitcoinjs-lib-v5");
var import_bufferutils = require("bitcoinjs-lib-v5/src/bufferutils.js");
...
function autoLoadPSBT(psbtFromFile, options) {
  ...
  if (psbtFromFile.substring(0, 10) === PSBT_MAGIC_HEX) {
    return import_bitcoinjs_lib_v55.Psbt.fromHex(psbtFromFile, options);
  } else if (psbtFromFile.substring(0, 7) === PSBT_MAGIC_B64) {
    return import_bitcoinjs_lib_v55.Psbt.fromBase64(psbtFromFile, options);
  } else {
    return null;
  }
}
...
function getWitnessOutputScriptFromInput(input) {
  const tx = import_bitcoinjs_lib_v55.Transaction.fromHex(input.transactionHex);
...
function psbtInputFormatter(input) {
  ...
  const nonWitnessUtxo = import_buffer.Buffer.from(input.transactionHex, "hex");
...
function psbtOutputFormatter(output) {
  ...
  if (output.multisig) {
    ...
    return {
      address: output.address,
      value: new import_bignumber5.default(output.amountSats).toNumber(),
      ...multisigScripts,
      bip32Derivation
    };
  }
...
function getUnchainedInputsFromPSBT(network, addressType, psbt) {
  return psbt.txInputs.map((input, index) => {
    ...
    const fundingTx = import_bitcoinjs_lib_v55.Transaction.fromHex(fundingTxHex);
...
var import_bitcoinjs_lib_v56 = require("bitcoinjs-lib-v5");
...
function parseDerivationPathNodesToBytes(path) {
  ...
  const bw = new import_bufio4.BufferWriter();
...
var PsbtV2Maps = class {
  ...
  constructor(psbt) {
    ...
    const br = new import_bufio4.BufferReader(buf);
  ...
  copyMap(from, to) {
    from.forEach((v3, k3) => to.set(k3, import_buffer.Buffer.from(v3)));
  }
};
var PsbtV2 = class _PsbtV2 extends PsbtV2Maps {
  ...
  set PSBT_GLOBAL_TX_MODIFIABLE(modifiable) {
    ...
    const br = new import_bufio4.BufferWriter();
    br.writeU8(val);
  ...
  get PSBT_OUT_AMOUNT() {
    ...
    for (const map of this.outputMaps) {
      ...
      const br = new import_bufio4.BufferReader(value);
  ...
  handleSighashType(sig) {
    const br = new import_bufio4.BufferReader(sig.slice(-1));
  ...
  static FromV0(psbt, allowTxnVersion1 = false) {
    ...
    const psbtv0 = import_bitcoinjs_lib_v56.Psbt.fromBuffer(psbtv0Buf);
...
function getPsbtVersionNumber(psbt) {
  const map = /* @__PURE__ */ new Map();
  const buf = bufferize(psbt);
  const br = new import_bufio4.BufferReader(buf.slice(PSBT_MAGIC_BYTES.length));
  readAndSetKeyPairs(map, br);
  return map.get("fb" /* PSBT_GLOBAL_VERSION */)?.readUInt32LE(0) || 0;
}

// src/script.ts
var import_bitcoinjs_lib_v57 = require("bitcoinjs-lib-v5");
function scriptToOps(multisig) {
  return import_bitcoinjs_lib_v57.script.toASM(multisig.output);
}
...
var import_bip66 = __toESM(require("bip66"));
var import_bitcoinjs_lib_v59 = require("bitcoinjs-lib-v5");

// src/transactions.ts
var import_bignumber6 = __toESM(require("bignumber.js"));
var import_bitcoinjs_lib_v58 = require("bitcoinjs-lib-v5");
function unsignedMultisigTransaction(network, inputs, outputs) {
  ...
  const transactionBuilder = new import_bitcoinjs_lib_v58.TransactionBuilder();
  ...
  for (let outputIndex = 0; outputIndex < outputs.length; outputIndex += 1) {
    ...
    transactionBuilder.addOutput(
      output.address,
      new import_bignumber6.default(output.amountSats).toNumber()
    );
  }
...
function unsignedMultisigPSBT(network, inputs, outputs, includeGlobalXpubs = false) {
  ...
  const multisigOutputError = validateOutputs(network, outputs);
  et(!multisigOutputError.length, multisigOutputError);
  const psbt = new import_bitcoinjs_lib_v58.Psbt({ network: networkData(network) });
  psbt.setVersion(1);
  ...
  if (includeGlobalXpubs && globalExtendedPublicKeys.length > 0) {
    const globalXpubs = globalExtendedPublicKeys.map((extendedPublicKey) => ({
      ...
      masterFingerprint: extendedPublicKey.rootFingerprint ? import_buffer.Buffer.from(extendedPublicKey.rootFingerprint, "hex") : import_buffer.Buffer.alloc(0),
...
function unsignedTransactionObjectFromPSBT(psbt) {
  return import_bitcoinjs_lib_v58.Transaction.fromHex(psbt.txn);
}
function signedMultisigTransaction(network, inputs, outputs, transactionSignatures) {
  ...
  const signedTransaction = import_bitcoinjs_lib_v58.Transaction.fromHex(unsignedTransaction.toHex());
  for (let inputIndex = 0; inputIndex < inputs.length; inputIndex++) {
    const input = inputs[inputIndex];
    ...
    if (multisigAddressType(input.multisig) === P2WSH) {
      ...
      signedTransaction.ins[inputIndex].script = import_buffer.Buffer.from([
        scriptSig.output.length,
        ...scriptSig.output
      ]);
    } else {
      const scriptSig = multisigScriptSig(input.multisig, sortedSignatures);
      signedTransaction.ins[inputIndex].script = scriptSig?.input ?? import_buffer.Buffer.alloc(0);
    }
  }
...
function multisigWitnessField(multisig, sortedSignatures) {
  ...
  return witness.map((wit) => import_buffer.Buffer.from(wit, "hex"));
}
function multisigScriptSig(multisig, signersInputSignatures) {
  ...
  const inputScriptBuffer = import_bitcoinjs_lib_v58.script.fromASM(inputScript);
  const rawMultisig = import_bitcoinjs_lib_v58.payments.p2ms({
    network: multisig.network,
    output: import_buffer.Buffer.from(multisigRedeemScript(multisig).output, "hex"),
...
function validateMultisigSignature(network, inputs, outputs, inputIndex, inputSignature) {
  ...
  for (let publicKeyIndex = 0; publicKeyIndex < multisigTotalSigners(input.multisig); publicKeyIndex++) {
    ...
    const publicKeyBuffer = import_buffer.Buffer.from(publicKey, "hex");
...
function multisigSignatureHash(network, inputs, outputs, inputIndex) {
  ...
  if (multisigAddressType(input.multisig) === P2WSH || multisigAddressType(input.multisig) === P2SH_P2WSH) {
    return unsignedTransaction.hashForWitnessV0(
      ...
      new import_bignumber7.default(input.amountSats).toNumber(),
      import_bitcoinjs_lib_v59.Transaction.SIGHASH_ALL
    );
  } else {
...
function multisigSignatureBuffer(signature) {
  const encodedSignerInputSignatureBuffer = import_buffer.Buffer.from(signature, "hex");
  const decodedSignerInputSignatureBuffer = import_bip66.default.decode(
  ...
  const signatureBuffer = import_buffer.Buffer.alloc(64);
  signatureBuffer.set(import_buffer.Buffer.from(rToUse), 32 - rToUse.byteLength);
  signatureBuffer.set(import_buffer.Buffer.from(s3), 64 - s3.byteLength);
  return signatureBuffer;
}
var isValidSignature = (pubkey, msghash, signature) => import_bitcoinjs_lib_v59.ECPair.fromPublicKey(pubkey).verify(msghash, signature);
